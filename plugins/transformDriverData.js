...
export default (_, inject) => {
  ...
  inject('transformDriverData', (rawData) =>
    rawData.map((rawItem) => {
      return {
        ...
        gap: transformDistance(
          rawItem.timeBehindLeader,
          rawItem.lapsBehindLeader
        ),
        interval: transformDistance(
          rawItem.timeBehindNext,
          rawItem.lapsBehindNext
        ),
